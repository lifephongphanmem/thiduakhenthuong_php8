...
Route::group(['prefix' => 'KhenThuongCongHien'], function () {
    Route::group(['prefix' => 'HoSoKT'], function () {
        ...
        Route::get('InHoSoKT', [dshosokhenthuongconghienController::class, 'InHoSoPD']);
    ...
    Route::group(['prefix' => 'HoSo'], function () {
        ...
        Route::post('ThemTongHop', [dshosodenghikhenthuongconghienController::class, 'ThemTongHop']);
    ...
    Route::group(['prefix' => 'TiepNhan'], function () {
        ...
        Route::get('QuaTrinhXuLyHoSo', [tnhosodenghikhenthuongconghienController::class, 'QuaTrinhXuLyHoSo']);
        Route::get('DsHoSoThamDinh',[tnhosodenghikhenthuongconghienController::class,'HoSoThamDinh']);
    });
