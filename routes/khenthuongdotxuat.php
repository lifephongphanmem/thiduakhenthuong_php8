...
Route::group(['prefix' => 'KhenThuongDotXuat'], function () {
    ...
    Route::group(['prefix' => 'HoSo'], function () {
        ...
        Route::post('ThemTongHop', [dshosodenghikhenthuongdotxuatController::class, 'ThemTongHop']);
    ...
    Route::group(['prefix' => 'TiepNhan'], function () {
        ...
        Route::get('DsHoSoThamDinh',[tnhosodenghikhenthuongdotxuatController::class,'HoSoThamDinh']);
    });
