...
class qdhosodenghikhenthuongkhangchienController extends Controller
{
    public static $url = '';
    public function __construct()
    {
        static::$url = '/KhenThuongKhangChien/KhenThuong/';
    ...
    {
        if (!chkPhanQuyen('qdhosodenghikhenthuongkhangchien', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'qdhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        ...
        $m_donvi = getDonVi(session('admin')->capdo, 'qdhosodenghikhenthuongkhangchien');
        ...
        $inputs['maloaihinhkt'] = session('chucnang')['qdhosodenghikhenthuongkhangchien']['maloaihinhkt'] ?? 'ALL';
        ...
        $inputs['trangthai'] = session('chucnang')['qdhosodenghikhenthuongkhangchien']['trangthai'] ?? 'CC';
        //dd($inputs);
        return view('NghiepVu.KhenThuongKhangChien.QuyetDinhKhenThuong.ThongTin')
            ->with('inputs', $inputs)
            ->with('model', $model)
    ...
    public function PheDuyet(Request $request)
    {
        ...
        return view('NghiepVu.KhenThuongKhangChien.QuyetDinhKhenThuong.PheDuyetKT')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('qdhosodenghikhenthuongkhangchien', 'hoanthanh')) {
            return view('errors.noperm')
                ->with('machucnang', 'qdhosodenghikhenthuongkhangchien')
    ...
    {
        if (!chkPhanQuyen('qdhosodenghikhenthuongkhangchien', 'thaydoi')) {
            return view('errors.noperm')
                ->with('machucnang', 'qdhosodenghikhenthuongkhangchien')
        ...
        $url_tl = '/KhenThuongKhangChien/XetDuyet/ThongTin';       
        $a_taikhoan = array_column(dstaikhoan::select('tentaikhoan', 'tendangnhap')->get()->toarray(), 'tentaikhoan', 'tendangnhap');
        $noidung = $a_taikhoan[session('admin')->tendangnhap] . ' trả lại hồ sơ hồ sơ phê duyệt ';
        $chucnang = 'khangchien';
        storeThongBao($url_tl, $noidung, $chucnang, $inputs['mahoso'], null, $model->madonvi, $model->madonvi_xd,'quanly',null,'xdhosodenghikhenthuongkhangchien');
    ...
    public function XemHoSo(Request $request)
    {
        ...
        return view('NghiepVu.KhenThuongKhangChien.QuyetDinhKhenThuong.Xem')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
