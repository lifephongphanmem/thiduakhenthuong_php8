...
class xdhosodenghikhenthuongkhangchienController extends Controller
{
    public static $url = '';
    public function __construct()
    {
        static::$url = '/KhenThuongKhangChien/XetDuyet/';
    ...
    {
        if (!chkPhanQuyen('xdhosodenghikhenthuongkhangchien', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'xdhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        ...
        $m_donvi = getDonVi(session('admin')->capdo, 'xdhosodenghikhenthuongkhangchien');
        $m_diaban = dsdiaban::wherein('madiaban', array_column($m_donvi->toarray(), 'madiaban'))->get();

        $inputs['nam'] = $inputs['nam'] ?? 'ALL';
        $inputs['madonvi'] = $inputs['madonvi'] ?? $m_donvi->first()->madonvi;
        $inputs['maloaihinhkt'] = session('chucnang')['xdhosodenghikhenthuongkhangchien']['maloaihinhkt'] ?? 'ALL';
        ...
        $inputs['trangthai'] = session('chucnang')['xdhosodenghikhenthuongkhangchien']['trangthai'] ?? 'CC';
        $inputs['trangthai'] = $inputs['trangthai'] != 'ALL' ? $inputs['trangthai'] : 'CC';
        //dd($model->where('trangthai','CXKT')->where('madonvi_kt',''));
        // dd( $inputs);
        // dd($model);
        return view('NghiepVu.KhenThuongKhangChien.XetDuyetHoSo.ThongTin')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('xdhosodenghikhenthuongkhangchien', 'hoanthanh')) {
            return view('errors.noperm')->with('machucnang', 'xdhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'hoanthanh');
        }
        $inputs = $request->all();
    ...
    {
        if (!chkPhanQuyen('xdhosodenghikhenthuongkhangchien', 'thaydoi')) {
            return view('errors.noperm')
                ->with('machucnang', 'xdhosodenghikhenthuongkhangchien')
        ...
        $inputs['url_xd'] = '/KhenThuongKhangChien/XetDuyet/';
        $inputs['url_qd'] = '/KhenThuongKhangChien/KhenThuong/';
        $inputs['mahinhthuckt'] = session('chucnang')['xdhosodenghikhenthuongkhangchien']['mahinhthuckt'] ?? 'ALL';
        ...
        return view('NghiepVu.KhenThuongKhangChien.XetDuyetHoSo.XetKT')
            ->with('model', $model)
    ...
    public function TrinhKetQua(Request $request)
    {
        ...
        $inputs['url_hs'] = '/KhenThuongKhangChien/HoSo/';
        $inputs['url_xd'] = '/KhenThuongKhangChien/XetDuyet/';
        $inputs['url'] = '/KhenThuongKhangChien/XetDuyet/';
        $inputs['url_qd'] = '/KhenThuongKhangChien/KhenThuong/';
        $inputs['phanloaihoso'] = 'dshosothiduakhenthuong';
        ...
        //dd($model_tailieu);
        return view('NghiepVu.KhenThuongKhangChien.XetDuyetHoSo.TrinhKetQua')
            ->with('model', $model)
