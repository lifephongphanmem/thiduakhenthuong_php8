...
class tnhosodenghikhenthuongkhangchienController extends Controller
{
    public static $url = '/KhenThuongKhangChien/TiepNhan/';
    ...
    {
        if (!chkPhanQuyen('tnhosodenghikhenthuongkhangchien', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'tnhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        $inputs['url_hs'] = '/KhenThuongKhangChien/HoSo/';
        $inputs['url_xd'] = '/KhenThuongKhangChien/TiepNhan/';
        $inputs['url_qd'] = '/KhenThuongKhangChien/KhenThuong/';
        $inputs['phanquyen'] = 'tnhosodenghikhenthuongkhangchien';
        ...
        $inputs['url_thamdinh'] = '/KhenThuongKhangChien/TiepNhan/DsHoSoThamDinh';

        $m_donvi = getDonVi(session('admin')->capdo, 'tnhosodenghikhenthuongkhangchien');
        ...
        $inputs['maloaihinhkt'] = session('chucnang')['tnhosodenghikhenthuongkhangchien']['maloaihinhkt'] ?? 'ALL';
        ...
        $inputs['trangthai'] = session('chucnang')['tnhosodenghikhenthuongkhangchien']['trangthai'] ?? 'CC';
        $inputs['trangthai'] = $inputs['trangthai'] != 'ALL' ? $inputs['trangthai'] : 'CC';
        //dd($model->where('trangthai','CXKT')->where('madonvi_kt',''));
        return view('NghiepVu.KhenThuongKhangChien.TiepNhan.ThongTin')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('tnhosodenghikhenthuongkhangchien', 'tiepnhan')) {
            return view('errors.noperm')->with('machucnang', 'tnhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'tiepnhan');
        }
        $inputs = $request->all();
    ...
    {
        if (!chkPhanQuyen('tnhosodenghikhenthuongkhangchien', 'hoanthanh')) {
            return view('errors.noperm')->with('machucnang', 'tnhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'hoanthanh');
        }
        $inputs = $request->all();
    ...
    {
        if (!chkPhanQuyen('tnhosodenghikhenthuongkhangchien', 'xuly')) {
            return view('errors.noperm')->with('machucnang', 'tnhosodenghikhenthuongkhangchien')->with('tenphanquyen', 'xuly');
        }
        $inputs = $request->all();
        //gán trạng thái hồ sơ để theo dõi
