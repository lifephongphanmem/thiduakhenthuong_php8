...
class qdhosodenghikhenthuongnienhanController extends Controller
{
    public static $url = '';
    ...
    {
        if (!chkPhanQuyen('qdhosodenghikhenthuongnienhan', 'danhsach')) {
            return view('errors.noperm')->with('machucnang', 'qdhosodenghikhenthuongnienhan')->with('tenphanquyen', 'danhsach');
        }
        $inputs = $request->all();
        ...
        $m_donvi = getDonVi(session('admin')->capdo, 'qdhosodenghikhenthuongnienhan');
        ...
        $inputs['maloaihinhkt'] = session('chucnang')['qdhosodenghikhenthuongnienhan']['maloaihinhkt'] ?? 'ALL';
        ...
        $inputs['trangthai'] = session('chucnang')['qdhosodenghikhenthuongnienhan']['trangthai'] ?? 'CC';
        //dd($inputs);
        return view('NghiepVu.KhenThuongNienHan.QuyetDinhKhenThuong.ThongTin')
            ->with('inputs', $inputs)
            ->with('model', $model)
    ...
    public function PheDuyet(Request $request)
    {
        ...
        //$inputs['mahinhthuckt'] = session('chucnang')['qdhosodenghikhenthuongnienhan']['mahinhthuckt'] ?? 'ALL';
        $model = dshosothiduakhenthuong::where('mahosotdkt', $inputs['mahosotdkt'])->first();
        ...
        return view('NghiepVu.KhenThuongNienHan.QuyetDinhKhenThuong.PheDuyetKT')
            ->with('model', $model)
    ...
    {
        if (!chkPhanQuyen('qdhosodenghikhenthuongnienhan', 'hoanthanh')) {
            return view('errors.noperm')
                ->with('machucnang', 'qdhosodenghikhenthuongnienhan')
    ...
    public function TraLai(Request $request)
    {
        ...
        $url_tl = '/KhenThuongNienHan/XetDuyet/ThongTin';       
        ...
        $chucnang = 'nienhan';
        storeThongBao($url_tl, $noidung, $chucnang, $inputs['mahoso'], null, $model->madonvi, $model->madonvi_xd,'quanly',null,'xdhosodenghikhenthuongnienhan');
    ...
    public function XemHoSo(Request $request)
    {
        ...
        return view('NghiepVu.KhenThuongNienHan.QuyetDinhKhenThuong.Xem')
            ->with('model', $model)
            ->with('model_canhan', $model_canhan)
            ->with('model_tapthe', $model_tapthe)
