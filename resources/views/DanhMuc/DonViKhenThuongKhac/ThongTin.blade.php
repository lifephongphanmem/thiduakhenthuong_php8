...
@section('custom-script-footer')
    ...
    <script>
        ...
        function add() {
            ...
            $('#frm_modify').find("[name='madonvi']").val(null);
            $('#frm_modify').find("[name='tendonvi']").val('');
        }
        ...
        function edit(id) {
            ...
            $.ajax({
                url: "/DonViKhenThuongKhac/LayChiTiet",
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
                ...
                success: function(data) {
                    ...
                    form.find("[name='madonvi']").val(data.madonvi);
                    form.find("[name='tendonvi']").val(data.tendonvi);
                }
            });
        }
    </script>
...
@section('content')
                                    ...
                                    <td style="text-align: center">
                                        @if (chkPhanQuyen('dmdonvikhenthuongkhac', 'thaydoi'))
                                            ...
                                            <button title="Xóa thông tin" type="button"
                                                onclick="confirmDelete('{{ $ct->id }}','{{ '/DonViKhenThuongKhac/Xoa' }}')"
    ...
    {!! Form::open(['url' => '/DonViKhenThuongKhac/Them', 'id' => 'frm_modify']) !!}
    <div id="modify-modal" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade kt_select2_modal">
        ...
        <input type="hidden" name=madonvi_nhap value={{$inputs['madonvi_nhap']}}>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                {!! Form::text('tendonvi', null, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {!! Form::open(['url' => '/DonViKhenThuongKhac/LayDonVi', 'id' => 'laydonvi']) !!}
