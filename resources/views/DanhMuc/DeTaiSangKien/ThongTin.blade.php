...
@section('content')
    ...
    <div class="card card-custom" style="min-height: 600px">
        <div class="card-header flex-wrap border-1 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label text-uppercase">Danh mục phân loại đề tài, sáng kiến </h3>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($model as $ct)
                                <tr>
                                    ...
                                    <td>{{ $ct->madetaisangkien }}</td>
                                    <td>{{ $ct->tendetaisangkien }}</td>
                                    <td style="text-align: center">
                                        @if (chkPhanQuyen('dmdetaisangkien', 'thaydoi'))
                                            ...
                                            <button title="Xóa thông tin" type="button"
                                                onclick="confirmDelete('{{ $ct->id }}','{{ '/DeTaiSangKien/Xoa' }}')"
    ...
    {!! Form::open(['url' => '/DeTaiSangKien/Them', 'id' => 'frm_modify']) !!}
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                {!! Form::text('tendetaisangkien', null, ['class' => 'form-control', 'required' => 'required']) !!}
                            </div>
                        </div>                        
                    </div>
                </div>
