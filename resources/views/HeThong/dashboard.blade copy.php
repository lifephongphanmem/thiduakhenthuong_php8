...
<div class="row">
    ...
    <!-- sử dụng db để hiển thị-->
    @foreach ($a_vp as $vp)
    <?php $vanphong = $model_vp->where('vanphong', $vp); ?>
    <div class="col-lg-{{ $col }} col-xl-{{ $col }} mb-5">
        <!--begin::Iconbox-->
        <div class="card card-custom mb-8 mb-lg-0">
            <div class="card-body">
                <div class="d-flex align-items-center p-5">
                    ...
                    <div class="d-flex flex-column">
                        <span class="text-dark text-hover-primary text-uppercase font-weight-bold font-size-h4 mb-3">{{ $vp }}</span>
                        <div class="text-dark-75">
