                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @if (chkPhanQuyen('tnhosodenghikhenthuongthidua', 'phanquyen'))
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ url('/TiepNhanHoSoThiDua/ThongTin') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            </i>
                                            <span
                                                class="menu-text font-weight-bold">{{ chkGiaoDien('tnhosodenghikhenthuongthidua', 'tenchucnang') }}</span>
                                        </a>
                                    </li>
                                @endif
                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                @endif
                                {{-- @if (chkPhanQuyen('tnhosothidua', 'phanquyen'))
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{ url('/HoSoThiDua/ThongTin') }}" class="menu-link">
                                            <i class="menu-bullet menu-bullet-dot">
                                                <span></span>
                                            ...
                                            <span
                                                class="menu-text font-weight-bold">{{ chkGiaoDien('tnhosothidua', 'tenchucnang') }}</span>
                                        </a>
                                    </li>
                                @endif --}}
