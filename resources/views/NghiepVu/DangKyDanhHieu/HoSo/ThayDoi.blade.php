...
@section('custom-script-footer')
    ...
    <script>
        ...
        function getCaNhan(id) {
            ...
            $.ajax({
                url: '/DangKyDanhHieu/HoSo/LayCaNhan',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
        ...
        function getTapThe(id) {
            ...
            $.ajax({
                url: '/DangKyDanhHieu/HoSo/LayTapThe',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
...
@section('content')
    ...
    {{-- Cá nhân --}}
    {!! Form::open([
        'url' => '/DangKyDanhHieu/HoSo/CaNhan',
        'id' => 'frm_ThemCaNhan',
        'class' => 'form',
        'files' => true,
        'enctype' => 'multipart/form-data',
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            {!! Form::select('madanhhieukhenthuong[]', $a_dhkt_canhan, null, [
                                'class' => 'form-control select2basic','style'=>'width:100%','multiple'=>true
                            ]) !!}
                        </div>
                    </div>
    ...
    {{-- tập thể --}}
    {!! Form::open([
        'url' => '/DangKyDanhHieu/HoSo/TapThe',
        'id' => 'frm_ThemTapThe',
        'class' => 'form',
        'files' => true,
        'enctype' => 'multipart/form-data',
