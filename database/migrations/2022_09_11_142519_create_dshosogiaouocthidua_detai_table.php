...
class CreateDshosogiaouocthiduaDetaiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosogiaouocthidua_detai', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosogiaouocthidua_detai');
    }
}
