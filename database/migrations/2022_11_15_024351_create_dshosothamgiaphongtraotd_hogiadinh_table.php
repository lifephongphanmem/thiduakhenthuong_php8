...
class CreateDshosothamgiaphongtraotdHogiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothamgiaphongtraotd_hogiadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosothamgiaphongtraotd_hogiadinh');
    }
}
