...
class CreateDshosodangkyphongtraothiduaHogiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosodangkyphongtraothidua_hogiadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosodangkyphongtraothidua_hogiadinh');
    }
}
