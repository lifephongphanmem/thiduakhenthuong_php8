...
class CreateDshosothamgiaphongtraotdTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothamgiaphongtraotd', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('mahosothamgiapt')->unique();    
    ...
    {
        Schema::dropIfExists('dshosothamgiaphongtraotd');
    }
}
