...
class CreateDshosotdktcumkhoiHogiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosotdktcumkhoi_hogiadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosotdktcumkhoi_hogiadinh');
    }
}
