...
class CreateDshosokhencaoHogiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosokhencao_hogiadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosokhencao_hogiadinh');
    }
}
