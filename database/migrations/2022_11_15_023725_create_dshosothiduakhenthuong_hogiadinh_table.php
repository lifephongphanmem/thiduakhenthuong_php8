...
class CreateDshosothiduakhenthuongHogiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothiduakhenthuong_hogiadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosothiduakhenthuong_hogiadinh');
    }
}
