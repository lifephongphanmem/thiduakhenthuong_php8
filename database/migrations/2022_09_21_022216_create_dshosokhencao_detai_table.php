...
class CreateDshosokhencaoDetaiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosokhencao_detai', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosokhencao_detai');
    }
}
