...
class CreateDshosotdktcumkhoiToadoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosotdktcumkhoi_toado', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosotdktcumkhoi_toado');
    }
}
