...
class CreateDshosothiduakhenthuongDetaiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosothiduakhenthuong_detai', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosothiduakhenthuong_detai');
    }
}
