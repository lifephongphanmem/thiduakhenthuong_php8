...
class CreateDshosodenghikhencaoHogiadinhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dshosodenghikhencao_hogiadinh', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('dshosodenghikhencao_hogiadinh');
    }
}
